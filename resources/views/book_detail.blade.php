...
<div class="container mt-3 ">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row mt-4">
                            ...
                            @foreach($RelatedBook as $Relatedbook)
                            <div class="col-md-4 col-lg-4 mb-4">
                                <div class="card border-0 shadow-lg">
                            <span>{{ $Relatedbook->id}}</span>
                                ...
                                <div class="card border-0 shadow-lg my-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="text-muted">{{ \Carbon\Carbon::parse($review->created_at)->format('m Y, d') }}</span>         
                                        </div>
                                       <?php
                                        $reviewParcenteg = ($review->rating/5)*100;
                                        ?>
                                            ...
                                            <div class="star-rating d-inline-flex" title="">
                                                <div class="star-rating d-inline-flex " title="">
                                                    <div class="back-stars ">
                                                        ...
                                                        <div class="front-stars" style="width:{{ $reviewParcenteg }}%">
                                                            <i class="fa fa-star" aria-hidden="true"></i>
                                                            <i class="fa fa-star" aria-hidden="true"></i>
                                                            <i class="fa fa-star" aria-hidden="true"></i>
                                                            <i class="fa fa-star" aria-hidden="true"></i>
    ...
    <div class="modal fade " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
           ...
           <form name="ReviewSubmit" id="ReviewSubmit">
                ...
                <div class="modal-body">
                    <input type="hidden" name="book_id" id="book_id" value="{{ $book->id }}">
                        <div class="mb-3">
                         ...
                         <p class="invalid-feedback" id="review_error"></p>
                        </div>
                        <div class="mb-3">
...
<script>
    ...
    $('#ReviewSubmit').submit( function(e){
        e.preventDefault();
        $.ajax({
            url: '{{ route('books.StoreReview') }}',
            type: 'POST',
            data: $('#ReviewSubmit').serializeArray(),
            headers: {
            ...
            success: function(respone){
                 if(respone.status == false){
                    ...
                    if(errors.review){
                      ...
                      $('#review_error').html(errors.review);
                    }else{
                        $('#review').removeClass('is-invalid');
                        $('#review_error').html('');
                    }
                 }else{
                    window.location.href = '{{ route('books.detail', $book->id)}}';
                 }
            }
        })
    });
