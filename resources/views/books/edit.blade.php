                    ...
                    <div class="card-body">
                      <form action="{{ route('books.update',$book->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('title', $book->title) }}" class="@error('title') is-invalid @enderror form-control" placeholder="Title" name="title" id="title" />
                         @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            @if(!empty($book->image))
                            <img src="{{ asset('uploads/books/thumb/'. $book->image) }}" width="150" class="my-2" alt="">
                            @endif
                         @error('image')
                         <p class="invaild-feedback">{{ $message}}</p>
                         @enderror
