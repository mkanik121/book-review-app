                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('name',$user->name) }}" class="@error('name') is-invalid @enderror form-control" placeholder="Name" name="name" id="" />
                              @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('email',$user->email) }}" class="@error('email') is-invalid @enderror form-control" placeholder="Email"  name="email" id="email"/>
                            @error('email')
                            <p class="invalid-feedback"> {{ $message }}</p>
                            @enderror
                        </div>
